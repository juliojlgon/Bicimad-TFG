...
//
//        ListAdapteeCollection<History> adapteeCollection = new ListAdapteeCollection<>();
//
//        RVRendererAdapter adapter = new RVRendererAdapter<History>(rendererBuilder, adapteeCollection);
